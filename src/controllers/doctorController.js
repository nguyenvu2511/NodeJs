...
let deleteScheduleByDate = async (req, res) => {
    try {
        let infor = await doctorService.deleteScheduleByDate(req.body);
...
let getListPatientDone = async (req, res) => {
    try {
        let info = await doctorService.getListPatientDone(req.query.doctorId);
        return res.status(200).json(info);
    } catch (e) {
        console.log(e);
        return res.status(200).json({
...
let chooseDoctor = async (req, res) => {
    try {
        let info = await doctorService.chooseDoctor(req.body);
