...
let initWebRoutes = (app) => {
    ...
    router.post('/api/delete-schedule-by-date', doctorController.deleteScheduleByDate);
    router.get('/api/get-extra-info-doctor-by-id', doctorController.getExtraInfoDoctorById);
    router.get('/api/get-profile-doctor-by-id', doctorController.getProfileDoctorById);

    router.get('/api/get-list-patient-for-doctor', doctorController.getListPatientForDoctor);
    router.get('/api/get-list-patient-done', doctorController.getListPatientDone);
    router.post('/api/send-remedy', doctorController.sendRemedy);
    router.post('/api/choose-doctor', doctorController.chooseDoctor);
    ...
    router.post('/api/delete-clinic-by-id', clinicController.deleteClinic);
